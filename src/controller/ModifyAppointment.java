...
public class ModifyAppointment implements Initializable {
    ...
    */
    ...
    public void modifyButtonClick(ActionEvent actionEvent) throws IOException, SQLException {
        ...
        customerName = CustomerDatabase.getCustomerNameID(customerID);
        ...
        if (title.isEmpty()) {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText("Please enter author.");
            alert.showAndWait();
            ...
            if (Appointment.withinBusinessHours(startTime) && Appointment.withinBusinessHours(endTime)) {
                ...
                if (startTime.toLocalTime().isBefore(endTime.toLocalTime())) {
                    ...
                    if (Appointment.checkTimeAvailability(customerID, chosenDate, start, end, apptID)) {
                        Alert alert = new Alert(Alert.AlertType.ERROR);
                        alert.setTitle("Error");
                        alert.setHeaderText("Desired meeting time not available.");
                        ...
                        Appointment modAppt = new Appointment(apptID, title, description, location, type, startTime, endTime, customerID, userID, contactID, contactName, customerName);
