...
public class ApptDatabase {
    ...
    public static ObservableList<Appointment> getAllAppointments() {
        ...
        try {
            String sql = "SELECT apt.Appointment_ID, apt.Title, apt.Description, apt.Location, apt.Type, apt.Start, " +
                    "apt.End, apt.Customer_ID, u.User_ID, c.Contact_ID, c.Contact_Name, cust.Customer_Name " +
            ...
            while (resultSet.next()) {
                ...
                Appointment appointment = new Appointment(apptID, title, description, location, type, startTime, endTime, customerID, userID, contactID, contactName, customerName);
    ...
    public static ObservableList<Appointment> getApptByID(int custID) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String customerName = CustomerDatabase.getCustomerNameID(customerID);


            Appointment appointment = new Appointment(apptID, title, description, location, type, startDate, endDate, customerID, userID, contactID, contactName, customerName);
    ...
    public static ObservableList<Appointment> getApptByMonth(String inputMonth) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            Appointment appointment = new Appointment(appointmentID, title, description, location, type, startDate, endDate, customerID, userID, contactID, contactName, customerName);
