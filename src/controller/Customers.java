...
public class Customers implements Initializable {
    ...
    public void apptButtonClick(ActionEvent actionEvent) throws IOException {
        ...
        stage.setTitle("Meeting Scheduler");
    ...
    public void modifyCustomerButtonClick(ActionEvent actionEvent) throws IOException {
        try {
            ...
            Stage stage = (Stage) ((Button) actionEvent.getSource()).getScene().getWindow();
            stage.setTitle("Modify Existing Author");
            stage.setScene(new Scene(root));
            stage.show();
            ...
            alert.setContentText("Please selected author to modify.");
            alert.show();
    ...
    public void deleteCustomerButtonClick(ActionEvent actionEvent) throws SQLException {
        ...
        if (deleteCustomer == null) {
            ...
            alert.setHeaderText("No author selected to delete.");
            alert.setContentText("Please select author.");
            alert.show();
        } else {
            ...
            if (ApptDatabase.custHasAppt(deleteCustID)) {
                ...
                alert.setTitle("Error");
                alert.setHeaderText("Author not deleted.");
                alert.setContentText("Please remove appointments associated with this author before attempting to delete customer.");
                alert.showAndWait();
            } else {
                // pop up to ensure customer is intending to delete a customer
                Alert confirm = new Alert(Alert.AlertType.CONFIRMATION);
                confirm.setTitle("Confirm Delete Action");
                confirm.setHeaderText("Are you sure you want to delete this author?");
                Optional<ButtonType> result = confirm.showAndWait();
                if (result.isPresent() && result.get() == ButtonType.OK) {
                    ...
                    inform.setHeaderText("Author successfully deleted!");
                    inform.show();
                }
            }
        }
