...
public class Appointment {
     ...
     */
    public Appointment(int apptID, String title, String description, String location, String type, LocalDateTime startTime, LocalDateTime endTime, int customerID, int userID, int contactID, String contactName, String customerName) {
        this.apptID = apptID;
        this.title = title;
    ...
    public static Appointment searchForAppointment(int apptID) {
        for (Appointment searchedAppointment : appointments) {
            if (searchedAppointment.getApptID() == apptID) {
    ...
    public static ObservableList<Appointment> searchForAppointment(String partialTitle) {
        ObservableList<Appointment> nameOfAppointment = FXCollections.observableArrayList();
        for (Appointment searchedAppointment : appointments) {
            if (searchedAppointment.getTitle().contains(partialTitle)) {
                nameOfAppointment.add(searchedAppointment);
            }
